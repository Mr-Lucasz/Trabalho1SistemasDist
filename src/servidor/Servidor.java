            ...
            while (true) {
                ...
                try (BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream()));
                    ...
                    while ((msg = in.readLine()) != null) {
                        ...
                        if (msg.startsWith("INSERT_HOTEL") || msg.startsWith("UPDATE_HOTEL")
                                || msg.startsWith("GET_HOTEL") ||
                                msg.startsWith("DELETE_HOTEL") || msg.startsWith("LIST_HOTEL")
                                || msg.startsWith("SELECT_HOTEL")) {
